...
def save_data_array(data, path_output):
...
def find_best_ref(transcription, reference_list_zero, reference_list, spk, path_output_log):
    ...
    #print("find_best_ref: ")
    #embed()
    save_data_array(reference_list, path_output_log)
...
def get_reference_from_system_alignments(reference_transcriptions_path, labels_dir_path, system_alignments, utterance_list, path_output_log):
    ...
    for utterance in utterance_list:
        ...
        best_ref_auto, best_ref_auto_zero = find_best_ref(trans_auto, ref_dict_with_zeros[sent], ref_dict_without_zeros[sent], spk, path_output_log)
